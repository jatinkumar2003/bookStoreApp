...
function Navbar() {
  ...
  <div className="hidden md:block"> {/*It means hidden by default but visible in devices greater than medium size */}
  <label className="px-3 py-2 border rounded-md flex items-center gap-2">
  <input type="text" className="grow outline-none dark:bg-slate-900 dark:text-white" placeholder="Search" /> {/* Dark mode applied for inputr field also */}
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 16"
    fill="currentColor"
  ...
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
      onClick={()=>setTheme(theme==="dark"?"light":"dark")} >  {/* After this add dark mode : class in tailwind config file */}
    <path
